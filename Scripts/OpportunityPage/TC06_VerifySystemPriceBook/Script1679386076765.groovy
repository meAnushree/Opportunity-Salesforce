...
String helptext = WebUI.getText(findTestObject('OpportunityPage/EditOpportunityPage/hover'))

'Verify the help section text'
WebUI.verifyEqual(helptext, systemHoverText)

String priceBook = WebUI.getText(findTestObject('OpportunityPage/EditOpportunityPage/SystemPriceBookBelowCloud', [('value') : systemPriceBook]))
...
WebUI.check(findTestObject('OpportunityPage/CreateOpportunity/SystemPriceBookCheckbox'))
...
WebUI.click(findTestObject('OpportunityPage/CreateOpportunity/SystemPriceBookCheckbox'))
